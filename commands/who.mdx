...
This means a contributor who has committed as `Alice <alice@gmail.com>` and `Alice <alice@work.com>` appears as a single entry with both emails listed. The longest name is kept as the display name (usually the real full name).
